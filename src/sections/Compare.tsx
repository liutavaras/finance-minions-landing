const COMPETITORS = [
  ...
  { name: 'FinchFlow', approach: 'Agent architecture with financial awareness', flexibility: 'Purpose-built, task-specific, auditable', speed: 'Handles real workflows end-to-end', cost: 'Affordable, subscription-based' },
]
